...
// Прерываем функцию пустым ретерном

// const arr = function(){
//   const input = prompt (`Enter login`);  //промпт всегда возвращает строку!
//  ///1
//   if(input === null){
//     return;   /// таким образом прекращаем продолжение функции
// }
// //2
// // const user = input.split(" "); // преобразуем ввод юзера в масив из строк
// const user = Number(input); // преобразует в число, обязательно кавычки ставим перменную!!!!
// console.log(user);
// return user;                   /// возвращаем результат юзера в ретерн не арр!!
// }
// arr();  /// вызов функции и по факту сюда будет записоватся результат функции
...
// const [y,...rest] = x;    ///рест собирает в колекцию

// console.log(y);
// console.log(rest);

//////////////////    Метод arguments (зарезервированое слово)   ////////////////////

//Ппри передаче большого количества аргументов лучше использовать такие методы как
//  1) const x =  Array.from(arguments);  /// зарезервированое слово
//  2) const x = [...arguments];

/////////////////////// Важно еще по передаче большого количества аргументов

// const summ = function (...rest){                  ///[1, 2, 3, 4, 5, 6]
// // const summ = function (x,y,z,...rest){        /////[4, 5, 6]

//  console.log(rest);                             /// покажет массив
// //   let result = 0;
...
// }
// summ(1,2,3,4,5,6);
// console.log(summ(1,2,3,4,5,6));  ///покажет массив
// console.log(summ);               ///ничего не покажет

///====================================
// Функция обратного вызова (callback-функция) - это функция, которая передается другой
//  функции в качестве аргумента и та, в свою очередь, вызывает переданную функцию.

///====================================================

// Задача по перебору масива в масиве любой сложности
//1)
/////////////////////////// с 10 раза но получилось , проблема была  в скобках!!!!
// const flatten =  function self (arr) {
//   const newMasiv = [];

//   for (let elem of arr) {
//     const logic = Array.isArray(elem);

//     if (logic) {
//       for (let y of elem) { newMasiv.push(y);} 
//       } 
//       else {
//       newMasiv.push(elem);
//       }  
...
//  return newMasiv;
// }
// const numbers = [15, [5, 6], 5, [7, 8, 9], 6, 7, 9, 10, 105];

// let x = flatten (numbers);

// console.log(x);

//////////////======================    Рекурсия   ==================

//2) магия перебора масива в масиве (сложная задачка). 
...
// /// тут вся магия.1, через селф запускается обратный вызов функции, 2, далее используется перезапись, 3, и объеденение масиово
//          else {
//       flatArr.push(elem);
//     }
//   }
