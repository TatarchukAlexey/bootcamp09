...
//Не добавляйте папку node_modules в систему контроля версий, так что если вы используете Git, не забывайте добавить ее в файл (.gitignore)/ Обязателеьно точку перед гиигором ставим. Файл создаем в src или рядом. И так и так может работать. Именно он не даем заливать ноду всю на гит
